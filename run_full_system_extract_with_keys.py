#!/usr/bin/env python3
"""
Identical to run_full_system_extract.py, but injects template API keys directly
without using .env or os.environ.
Replace the placeholder values below with your real keys.
"""

# ===== Inline configuration (edit these) =====
OPENAI_API_KEY = "YOUR_OPENAI_API_KEY"
FIRECRAWL_API_KEY = "YOUR_FIRECRAWL_API_KEY"
GOOGLE_SEARCH_API_KEY = "YOUR_GOOGLE_SEARCH_API_KEY"  # optional
GOOGLE_SEARCH_CX = "YOUR_GOOGLE_SEARCH_CX"            # optional

# Optional Portkey routing
USE_PORTKEY = False
PORTKEY_BASE_URL = "https://api.portkey.ai/v1"
PORTKEY_VIRTUAL_KEY = ""
PORTKEY_API_KEY = ""

# ----- Bootstrap inline config cleanly (no os.environ) -----
def _configure_inline():
    import config as _config
    from config import Settings
    import openai_client as _oc
    from openai import OpenAI, AsyncOpenAI

    # Replace global settings with a new instance configured from inline values
    ...
    # Override the public OpenAI client factory so downstream uses inline keys
    def _make_openai_client(async_client: bool = False):
        if USE_PORTKEY:
            kwargs = {
                "api_key": "ignored",
    ...
    _oc.make_openai_client = _make_openai_client
    _oc.make_direct_openai_client = _make_openai_client
